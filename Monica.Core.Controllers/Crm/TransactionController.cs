...
namespace Monica.Core.Controllers.Crm
{
    ...
    public class TransactionController : BaseController
    {
        ...
        public TransactionController(ITransactionDataAdapter transaction) : base(ModuleName)
        {
            _transaction = transaction;
        }
        public TransactionController(IManagerClients managerClient) : base(ModuleName)
        {
